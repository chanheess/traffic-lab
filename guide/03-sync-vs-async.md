...
## 결과
> "유실되면 안 되는 비즈니스 이벤트는 @Async만으로 처리하지 않고, Outbox와 메시지 큐를 통해 영속성과 재처리 가능성을 확보해야 한다."
...
├──────────┼──────────────┼──────────────┼────────────┤
│ 평균     │        803ms │         37ms │     21.7x │
│ p50      │        789ms │         37ms │     21.3x │
│ p95      │        883ms │         51ms │     17.3x │
│ p99      │        901ms │         52ms │     17.3x │
│ 최대     │        901ms │         52ms │     17.3x │
└──────────┴──────────────┴──────────────┴────────────┘